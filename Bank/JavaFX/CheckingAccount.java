...
// This program allows the user to perform an action in the checking account
...
// This class deposits and withdraws money from a checking account
public class CheckingAccount extends Application {
...
private TextField tfCheckingBalance = new TextField();
...
gridPane.add(new Label("Checking Account"), 0, 0);
gridPane.add(new Label("Amount:"), 0, 2);
gridPane.add(tfAmount, 1, 2);
gridPane.add(new Label("Checking Account Balance:"), 0, 4);
gridPane.add(tfCheckingBalance, 1, 4);
  ...
  void getWithdrawalValid(){
	...
	private void getDeposit() {		
		...
		// Get Balance
        	...
        	tfCheckingBalance.setText(String.format("$%.2f", 
        			((balance + amount))));
        	balance += amount;
        }
	}
